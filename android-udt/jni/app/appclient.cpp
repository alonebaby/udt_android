...
#endif
{
   ...
   printf( "SendRate(Mb/s)\tRTT(ms)\tCWnd\tPktSndPeriod(us)\tRecvACK\tRecvNAK\n");
   ...
   while (true)
   {
      ...
      printf(" %f \t %f\t %d\t %d\t %d\t %d\t \n",perf.mbpsSendRate,perf.msRTT,perf.pktCongestionWindow,perf.usPktSndPeriod,perf.pktRecvACK,perf.pktRecvNAK);
/*
